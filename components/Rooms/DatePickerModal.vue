      ...
      <div :class="{ 'mt-auto': isConfirmDateOnMobile }" class="modal-content gap-6 gap-md-10 rounded-3xl">
        <div class="d-md-none modal-header px-6 py-4 bg-neutral-40">
          <div class="d-flex flex-column gap-4">
            <button type="button" class="btn-close" style="margin-left: -8px !important" @click="closeModal" />
            <h3 v-if="tempDate.date.end === null" class="text-neutral-100 fs-6 fw-bold">選擇入住與退房日期</h3>
            <div v-else class="d-flex align-items-center gap-4">
              <h3 class="modal-title mb-0 text-neutral-100 fs-6 fw-bold">{{ daysCount }} 晚</h3>
        ...
        <div class="d-none d-md-flex modal-header gap-15 p-8 pb-0 border-0">
          <div>
            <h3 class="modal-title mb-2 text-neutral-100 fs-5 fw-bold">{{ daysCount }} 晚</h3>
          ...
          <div class="d-flex flex-wrap gap-2 w-50 ms-auto">
            <div class="form-floating flex-grow-1">
              ...
              />
              <label class="text-neutral-80 fw-medium" style="top: 8px; left: 8px" for="checkInDate">入住 </label>
            </div>
            ...
            <div class="form-floating flex-grow-1">
              <input
                ...
                placeholder="yyyy-mm-dd"
              />
              <label class="text-neutral-80 fw-medium" style="top: 8px; left: 8px" for="checkoutDate">退房 </label>
            </div>
          </div>
        </div>
        <div class="modal-body px-6 px-md-8 py-0">
          ...
          <div v-else>
            ...
            <p className="mb-4 text-neutral-80 fs-8 fw-medium">此房型最多供 4 人居住，不接受寵物入住。</p>
