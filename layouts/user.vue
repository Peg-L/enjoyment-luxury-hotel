      ...
      <div class="container">
        <ul class="nav mb-10 mb-md-20 fw-bold">
          <li class="nav-item position-relative">
            <NuxtLink to="/member/profile" exact-active-class="text-primary-100" class="nav-link px-6 py-4 text-white">
              個人資料
            </NuxtLink>
          </li>
          <li class="nav-item position-relative">
            <NuxtLink to="/member/orders" exact-active-class="text-primary-100" class="nav-link px-6 py-4 text-white">
              我的訂單
            </NuxtLink>
          </li>
        </ul>
